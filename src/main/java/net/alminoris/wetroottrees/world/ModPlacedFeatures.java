package net.alminoris.wetroottrees.world;
...
public class ModPlacedFeatures
{
    ...
    {
        return RegistryKey.of(RegistryKeys.PLACED_FEATURE, Identifier.of(net.alminoris.wetroottrees.WetrootTrees.MOD_ID, name));
    }
