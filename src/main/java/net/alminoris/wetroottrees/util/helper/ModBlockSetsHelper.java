package net.alminoris.wetroottrees.util.helper;

import net.alminoris.wetroottrees.entity.ModBoats;
import net.alminoris.wetroottrees.world.tree.ModSaplingGenerators;
...
import static net.alminoris.wetroottrees.block.ModBlocks.*;
import static net.alminoris.wetroottrees.item.ModItems.*;

public class ModBlockSetsHelper
{
    //"platanus", "pink_lapacho"
    public static final String[] WOOD_NAMES = new String[] { "swamp tupelo", "river birch", "water hickory", "pumpkin ash" };
