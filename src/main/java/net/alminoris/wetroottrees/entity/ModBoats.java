package net.alminoris.wetroottrees.entity;

import com.terraformersmc.terraform.boat.api.TerraformBoatType;
import com.terraformersmc.terraform.boat.api.TerraformBoatTypeRegistry;
import net.alminoris.wetroottrees.util.helper.ModBlockSetsHelper;
...
public class ModBoats
{
    ...
    {{
        for(String name : ModBlockSetsHelper.WOOD_NAMES)
            put(name, Identifier.of(net.alminoris.wetroottrees.WetrootTrees.MOD_ID, name+"_boat"));
    }};

    public static Dictionary<String, Identifier> chestBoatIDs = new Hashtable<>()
    {{
        for(String name : ModBlockSetsHelper.WOOD_NAMES)
            put(name, Identifier.of(net.alminoris.wetroottrees.WetrootTrees.MOD_ID, name+"_chest_boat"));
    }};
